...
# Remove fields that API doesn't accept in POST
# Keep only: name, nodes, connections, settings, staticData, tags
clean_workflow = {
...
if response.status_code == 200 or response.status_code == 201:
    ...
    print(f'\nNext steps:')
    print(f'1. Open n8n: http://72.60.175.144:5678')
    print(f'2. Find workflow: {result.get("name")}')
    print(f'3. Configure credentials for Telegram and Gemini nodes')
else:
